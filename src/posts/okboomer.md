...
* Законодательство должно быть изменено в соответствии с международными стандартами и проанализировано ОБСЕ/БДИПЧ и Венецианской комиссией. Заявление Токаева не содержит серьезных изменений, общество требовало реформы политической системы, а взамен получило косметические изменения, которые не поменяют ситуацию в лучшую сторону.
...
Заявление Токаева не содержит серьезных изменений, общество требовало реформы политической системы, а взамен получило косметические изменения, кото

![](/images/nsod2-2-.png)

рые не поменяют ситуацию в лучшую сторону.
